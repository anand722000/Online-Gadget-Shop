					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a ><i class="fa fa-phone"></i> 7888788...</a></li>
								<li><a ><i class="fa fa-envelope"></i> anand@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="logo pull-left">
							<a href="admin.php"><img src="images/home/header.gif" alt="" class="img-responsive" height="100" width="2000" /></a>
						</div>
