					...
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="https://www.google-plus.coom"><i class="fa fa-google-plus"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="logo pull-left">
							<center><a href="index.php"><img src="images/home/header.jpg" alt=""  width="1500" height="300" class="img-responsive"/></a></center>
						</div>
